...
class PanelApp:
    def __init__(self):
        ...
        stores = panel_data.list_stores()
        default_store = "Onehunga" if "Onehunga" in stores else panel_data.ALL_STORES
        ...
        self._build_ui(stores)
        self.reload()

    # ---------- UI 构建 ----------
    def _build_ui(self, stores):
    ...
    def reload(self):
        ...
        s = data["summary"]
        src = "示例数据" if data["source"] == "sample" else "CSV"
