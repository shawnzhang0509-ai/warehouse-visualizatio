-- 停产 SKU：库存 + 原价/促销价（按 SKU 一行）→ Output-NZ/stock_discontinued.csv
-- 在产 SKU 见同目录 product_stock_price.sql → stock.csv
--
-- 用法:
--   SSMS: 改 @SkuFilter = '855' 只查某系列；留空 '' 查全部停产
--   本地执行器: 与 product_stock_price.sql 一起执行导出
--
